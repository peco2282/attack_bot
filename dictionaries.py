...
#keys = get_keys_from_value(d, 'aaa') print(keys)
"""
print(osdict)
a = str(input())
b = a.split()
...
async def on_message(message: discord.Message):
    ...
    if message.content.startswith(".a"):
        channel = await discord.create_text_channel(name = 'TEXT')
        channel2 = await discord.create_voice_channel(name = 'VOICE' , reason = None , category = None , position = ... , bitrate = ... , user_limit = ... , rtc_region = ... , video_quality_mode = ... , overwrites = ... )
        channel3 = await discord.create_stage_channel (name = 'STAGE' , position = ... , overwrites = ... , category = None , reason = None )
